...
!!!MODIFIED BY KARL REINISCH ON 9.10.2012!!!
...
(function($){
	...
	$.jMenu = {
		...
		init:function(options){
			...
			$("#jMenu a:not(.jmenu_root)").each(function(){
				var $thisChild = $(this);
		...
		****************************/
		...
		_isReadable:function(){
			if($("a.jmenu_root").length > 0)	return true;
			else return false;
		},
		
		_error:function(){
			alert('Please, check you have the \'.jmenu_root\' class on your first level links.');
		}
	};
